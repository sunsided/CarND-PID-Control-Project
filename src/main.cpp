...
int main() {
    ...
    auto pid_initial_error = 0.00131948;
    std::array<double, 3> pid_params{0.518219, 0.0002791, 0.5199};
    std::array<double, 3> pid_param_steps{0.0011, 0.00055, 0.00135};
#endif
    const auto twiddle_lambda = 0.5;
